            ...
            <div class="col-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary  " href="{{ route('contacts.index', $contact->id) }}">Back To Contacts List</a>
...
<!--
                                        <tr>
                                            ...
                                            <td> 
                                                <img src="{{ asset('/image/'.$contact->file) }}"    width= "220px"
  ...
  <section class="section">
        <div class="card">
            ...
            <span class="float-right">
                    <a class="btn btn-primary" href="{{ route('contact_followup', $contact->id) }}">Add New Follow Up</a>
                </span>
