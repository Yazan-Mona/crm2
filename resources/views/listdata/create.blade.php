...
@section('content')
@can('owner-create') 
<form action="{{ route('listdatas.store') }}" method="POST"> 
    @csrf
    <!-- Input Style start -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="status"  name ="status" class="form-control round"
                                        placeholder="status">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="unit_number"   name ="unit_number" class="form-control square"
                                        placeholder="unit_number  mobile Input">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="comment"  name ="comment" class="form-control round"
                                        placeholder="comment">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="contact"   name ="contact" class="form-control square"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="project"  name ="project" class="form-control round"
                                        placeholder="project">
                                </div>
                            </div>
                            <div class="col-sm-6">
