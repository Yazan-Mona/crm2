                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="unitNo"   name ="unitNo" class="form-control round"
                                        placeholder="{{$unitNo}}" value="{{$unitNo}}">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <label for="source">project</label>
                                        <select class="form-select" id="project_id" name="project_id">
                                                <option selected value="{{ $project[0]['id']}}">{{ $project[0]['name']}} </option>
                                ...
                                <div class="form-group">
                                    <label for="owner_id">owner </label>
                                        ...
                                        <select class="form-select" id="owner_id" name="owner_id">
                                                <option selected value="{{ $owner[0]['id'] }}">{{ $owner[0]['firstname']}} &nbsp&nbsp {{ $owner[0]['lastname']}}  </option>
